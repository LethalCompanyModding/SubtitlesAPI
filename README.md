...
A centralized API for fetching localized subtitles. This is a unified project also containing the packages formally known as Subtitles and AudibleDistanceLib, see their respective folders for more information.

## Feedback

Got any feedback or found bugs? Please do post it in [the Github Issues page](https://github.com/LethalCompanyModding/SubtitlesAPI/issues)!
